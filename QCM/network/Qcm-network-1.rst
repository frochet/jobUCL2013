...
Link state routing is an other type of routing protocols. When a router use link state routing, it sends message on the network. Which of theses affirmations are corrects?
