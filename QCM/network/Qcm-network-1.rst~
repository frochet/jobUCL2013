...
-
  ...
  .. class:: comment
	 	 ...
	 	 A LSP from a router contains informations about the links connected to him and to which neighbourg they are connected. It does not give information about how he can reach other routers.
...
-
  ...
  .. class:: comment
		  ...
		  A LSP from a router contains informations about the links connected to him and to which neighbourg they are connected. It does not compute a shortest path. The cost from E to D is thus 10 not 8.
...
The routers from question 1 uses distance vector routing. They sends their distance vector regularly over all theirs interfaces. Which one of these 
